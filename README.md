...
- `@raytonx/nest-notification`：通知模块，内置 Resend 邮件发送能力，提供 `NotificationModule` 与 `NotificationService`。[packages/notification/README.md](packages/notification/README.md)
